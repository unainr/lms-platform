                            ...
                            <ul className="flex gap-8 text-sm">
                                {menuItems.map((item, index) => (
                                    <li key={index}>
                                        <Link
                                            href={item.href}
                                            className={cn('text-accent-foreground hover:text-muted-foreground block duration-150',isActive(item.href)&&'text-blue-400 hover:text-blue-600 underline underline-offset-4  font-semibold')}>
                                            <span>{item.name}</span>
                                        </Link>
                                    </li>
                                ))}
